...
export default async function RugbyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      <RugbyHero title={competition?.name ?? 'Six Nations'} subtitle={competition?.season ?? 'Not synced yet — admin preview, not live to players'} />
      ...
      {user && alreadyJoined && (
        <div className="pop-panel pop-panel--pink p-5 mb-6">
          <h2 className="pop-headline text-base mb-4" style={{ color: 'var(--pop-white)' }}>Your Kit</h2>
