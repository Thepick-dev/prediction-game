...
import { pullNextBatch, checkQuota, type ExternalCompetition } from '../../../lib/rugbyExternalPerformanceSync'
          ...
          <div key={c.id} className="border rounded-lg p-4">
            ...
            {c.last_pull_summary && (
              <div className="mt-2 text-xs text-gray-700 bg-gray-50 rounded p-2">
                Last run: {c.last_pull_summary.matchesPulled} matches, {c.last_pull_summary.playerRowsStored} player rows,{' '}
