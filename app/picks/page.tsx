                ...
                {hasFixtures ? (
                  <div className="grid gap-2 sm:gap-2.5 mb-4 sm:mb-6">
                    {fixtures.map((fixture) => {
                      ...
                      return (
                        <div key={fixture.id} className="pop-panel p-1 sm:p-1.5">
                          <div className="flex items-center gap-1 sm:gap-1.5">
                            <button
                              ...
                              className={`pop-select-btn rounded-lg p-1.5 flex-1 min-w-0 flex items-center gap-1.5 text-left ${homeSelected ? 'pop-pop-in' : ''}`}
                              style={{
                            ...
                            <span
                              className="shrink-0 flex items-center justify-center font-black uppercase"
                              style={{
                                width: 20, height: 20, fontSize: '7px',
                                borderRadius: '999px',
                            ...
                            <button
                              ...
                              className={`pop-select-btn rounded-lg p-1.5 flex-1 min-w-0 flex items-center gap-1.5 text-left ${awaySelected ? 'pop-pop-in' : ''}`}
                              style={{
                            ...
                            >
                              ...
                              <TeamCrest teamId={awayTeam?.id ?? null} teamName={teamDisplayName(awayTeam)} size={26} />
                            </button>
                          </div>
                        </div>
                      )
