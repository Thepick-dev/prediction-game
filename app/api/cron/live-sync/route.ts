...
// without an admin manually clicking "Sync from FPL" during a match.
// Deliberately its own route rather than folding into /api/cron — that one
// only ever runs once a day and does unrelated things (locking gameweeks,
// autopicks); this needs a much tighter interval and should do nothing else.
